...
TreeNode *swapChildren(TreeNode *tree)
{
...
TreeNode *mirror(TreeNode *tree)
{
    ...
    {
        tr = swapChildren(tr);
        tr->left = mirror(tr->left);
        tr->right = mirror(tr->right);
    }
    return tr;
}
...
int main()
{
    ...
    printf("The Tree in preorder (after mirrorize):\n");
    printPreorder(tree);
    printf("\n**************************************\n");

    printf("The Tree in inorder (after mirrorize):\n");
    printInorder(tree);
    printf("\n**************************************\n");

    printf("The Tree in postorder (after mirrorize):\n");
    printPostorder(tree);
    printf("\n**************************************\n");
}